...
```text
verification/examples-aggregate-build-verification.md
verification/minigateway-step8-author-verification.md
verification/book-source-baseline.md
verification/book-source-baseline.env
```
