...
- The SNode.C repository and the source baseline recorded in `SOURCE-VERSION.md` are the authoritative sources for the framework version discussed in this book.
