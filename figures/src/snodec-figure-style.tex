...
\definecolor{snodecRule}{HTML}{7C8E9B}
\definecolor{snodecBlue}{HTML}{0B3D4A}
\definecolor{snodecBlueSoft}{HTML}{E3EEF4}
\definecolor{snodecGreen}{HTML}{2F6F5E}
\definecolor{snodecGreenSoft}{HTML}{E9F3EE}
\definecolor{snodecOrange}{HTML}{B86B2B}
\definecolor{snodecOrangeSoft}{HTML}{F8EEE5}
\definecolor{snodecRed}{HTML}{A64B4B}
\definecolor{snodecRedSoft}{HTML}{F7EAEA}
\definecolor{snodecGraySoft}{HTML}{F2F2EF}

% Title-color palette: same hue family as the box, but with stronger contrast.
\colorlet{snodecTitleBlue}{snodecBlue}
\colorlet{snodecTitleGreen}{snodecGreen!70!black}
\colorlet{snodecTitleOrange}{snodecOrange!90!black}
\definecolor{snodecTitleGray}{HTML}{52616B}
