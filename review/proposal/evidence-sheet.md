...
- **Manuscript:** 32 numbered chapters in 11 Parts, Appendix A, closing essay and reference material; **100,916 whitespace tokens**, of which 92,772 are prose and 8,144 occur in fences; **pages pending PDF rebuild**.
- **Teaching apparatus:** 99 objectives and 165 mapped exercises planned across 32 chapters and Appendix A. The four split chapters are awaiting the P3 apparatus gate. Each will have two review questions, two labs and one design problem, public solutions, and a recap of at most five bullets. All 11 Parts have runnable checkpoints; the epilogue is a closing essay.
- **Samples:** Chapters **1, 3, 19, 30 and 32**, using the same teaching pattern. Each retains at least a 20% reduction in prose from its original sample baseline. The sample guide identifies the skill and observable outcome each demonstrates.
