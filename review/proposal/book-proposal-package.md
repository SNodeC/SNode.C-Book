...
The 32-chapter structure and contributor appendix are implemented. Word counts come from the current Markdown manifest. The rebuilt reading PDF has 328 pages. Part page ranges are not quoted here; publisher trim and typesetting will change the printed extent.
