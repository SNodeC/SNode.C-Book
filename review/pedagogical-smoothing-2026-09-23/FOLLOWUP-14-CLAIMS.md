# Follow-up 14: verification of local changes

## A — article and exercise mappings

Before editing, inspected all CMakeLists.txt and README.md files in ch04, ch06
and ch32. `ch04/CMakeLists.txt:2–3` selects model-instances; its README section
3 explains shared versus separate models. `ch06/CMakeLists.txt:5–7` selects
model-ownership for the Part II checkpoint; README section 4 describes accepted
order and removing an observer. `ch32/CMakeLists.txt:1–10` defines both targets
and reuses the canonical model. Its README sections 3 and 4 already match those
respective experiments, so no solution or test edit is needed. Ch32 Ex3 now
