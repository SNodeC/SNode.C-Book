...
ctest --test-dir build/ci-book-examples --output-on-failure --no-tests=error --repeat until-fail:50 -R '^exercise-ch07-' | tee build/verification-logs/ch07-repeat50.txt
