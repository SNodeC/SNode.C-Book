...
The address model from Chapter 6 therefore does not end at startup. It remains visible on the live connection.
...
For Chapter 7, do not turn `State` into its own topic. Remember:
...
This is the same distinction introduced earlier, but Chapter 7 is where it becomes operationally concrete.
