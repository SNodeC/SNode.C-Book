...
In the boundary language of Chapter 23, a persistence service is especially useful when several protocol surfaces touch the same durable state. Validate and interpret input first, then schedule persistence and report success, failure or degraded state.
